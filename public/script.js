...
//             link.href = imageUrl;
//             link.innerText = 'View Image'; // Set the text of the link

//             // Append the <a> tag to the view button
//             viewButton.innerHTML = ''; // Clear previous content
...
//         // Handle clicking the link (e.g., open the image in a new tab)
//         const link = viewButton.querySelector('a');
//         if (link) {
